...
def generate_launch_description():
    ...
    is_scout_mini_arg = DeclareLaunchArgument(
        'is_scout_mini', default_value='true',
    ...
    velodyne_tf_node = Node(
        ...
        name='scout_to_velodyne_tf',
        arguments=['0.0', '0.0', '0.7', '0.0', '0.0', '0.0', 'base_link', 'velodyne']
    )
    camera_tf_node = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='scout_to_camera_tf',
        arguments=['0.20', '0.0', '0.24', '0.0', '0.0', '0.0', 'base_link', 'camera_link']
    )
